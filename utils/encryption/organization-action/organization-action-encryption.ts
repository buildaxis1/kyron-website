...
// Encrypt all PHI/sensitive fields for organizationAction
export function encryptOrganizationActionPHI(action: {
  content?: string | null;
...
// Decrypt all PHI/sensitive fields for organizationAction
export function decryptOrganizationActionPHI(action: any) {
