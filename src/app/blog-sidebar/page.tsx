  ...
  return (
    <>
      <section
        ...
        data-oid="ojfsek4"
      >
        <div className="container" data-oid="nrki9jv">
          <div className="-mx-4 flex flex-wrap" data-oid="vcizo9f">
            <div className="w-full px-4 lg:w-8/12" data-oid="3z-6ra1">
              <div data-oid="ta252wu">
                <h1
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="jaea96h"
                    >
                      <div className="mr-4" data-oid="m3ugev-">
                        <div
                      ...
                      <div className="w-full" data-oid="kxkoc9v">
                        <span
                          className="mb-1 text-base font-medium text-body-color"
                          data-oid="rc48ld1"
                        >
                          By <span data-oid="8crh0qm"> Musharof Chy</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center" data-oid="dy7noua">
                      <p
                        className="mr-5 flex items-center text-base font-medium text-body-color"
                        data-oid="za:2ysa"
                      >
                        <span className="mr-3" data-oid="ynpacvw">
                          <svg
                            width="15"
                            height="15"
                            viewBox="0 0 15 15"
                      ...
                      <p
                        ...
                        data-oid="phnk0hx"
                      >
                        <span className="mr-3" data-oid="rp_u.l-">
                          <svg
                            width="18"
                            height="13"
                            viewBox="0 0 18 13"
                      ...
                      <p
                        ...
                        data-oid="uwpezs0"
                      >
                        <span className="mr-3" data-oid="yyy49vg">
                          <svg
                            width="20"
                            height="12"
                            viewBox="0 0 20 12"
                  ...
                  <div className="mb-5" data-oid="5oh67y7">
                    <a
                      href="#0"
                ...
                <div data-oid="jasewic">
                  ...
                  <h3
                    className="font-xl mb-10 font-bold leading-tight text-foreground sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight"
                    data-oid="3acwafy"
                  >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <g mask="url(#mask0_111:596)" data-oid="qhnibz6">
                          <circle
                            opacity="0.8"
                            cx="37.5"
                            cy="37.5"
                        ...
                        <defs data-oid="zierbgp">
                          ...
                          <radialGradient
                            ...
                            data-oid="r_d61h."
                          >
                            <stop stopOpacity="0.47" data-oid="o0hgpn7" />
                            <stop
                              offset="1"
                              stopOpacity="0"
                              data-oid="62scuoy"
                  ...
                  <div
                    ...
                    data-oid="_y108g9"
                  >
                    <div className="mb-5" data-oid="6ucvf.0">
                      <h4
                      ...
                      <div className="flex items-center" data-oid="guh-ua4">
                        <TagButton text="Design" data-oid="tqsp6v1" />
                        <TagButton text="Development" data-oid="q9fv:5v" />
                        <TagButton text="Info" data-oid="0dok99h" />
                      </div>
                    </div>
                    <div className="mb-5" data-oid="a:k1zhw">
                      <h5
            ...
            <div className="w-full px-4 lg:w-4/12" data-oid=".9drlm5">
              <div
              ...
              >
                ...
                <ul className="p-8" data-oid=":4nm_97">
                  <li
              ...
              >
                ...
                <ul className="px-8 py-6" data-oid="ztcxo.7">
                  <li data-oid="6-70lbt">
                    <a
                      href="#0"
              ...
              >
                ...
                <div className="flex flex-wrap px-8 py-6" data-oid="95hl.iu">
                  <TagButton text="Themes" data-oid="1d_ozxq" />
                  <TagButton text="UI Kit" data-oid="8.7xain" />
                  <TagButton text="Tailwind" data-oid="5sldeb." />
                  <TagButton text="Startup" data-oid="x:0gwqu" />
                  <TagButton text="Business" data-oid="s-vvo4m" />
                </div>
              </div>

              <NewsLatterBox data-oid="f4rxnuj" />
            </div>
          </div>
        </div>
      </section>
