...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  for (let index = 0; index < star; index++) {
    ratingIcons.push(
      <span key={index} className="text-yellow" data-oid="op7gmjw">
        {starIcon}
      </span>,
    );
  }
  ...
  return (
    <div className="w-full" data-oid="_cqe:97">
      <div
        ...
        data-oid="iw1jo31"
      >
        <div className="mb-5 flex items-center space-x-1" data-oid="tpyhr5h">
          {ratingIcons}
        </div>
        <p
        ...
        <div className="flex items-center" data-oid="erps91.">
          <div
            className="relative mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full"
            data-oid="0dnk68s"
          >
            <Image src={image} alt={name} fill data-oid="f257_vh" />
          </div>
          <div className="w-full" data-oid="nib3dx-">
            <h3
            ...
            <p className="text-sm text-body-color" data-oid="mm87x6s">
              {designation}
            </p>
          </div>
        </div>
