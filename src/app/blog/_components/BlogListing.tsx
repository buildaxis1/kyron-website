        ...
        {featured && activeCategory === "All" && (
          ...
          >
            <Link
              ...
              className="group block overflow-hidden rounded-2xl border bg-gradient-to-r from-sky-500/10 via-card to-indigo-500/10 p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl md:p-10"
            >
              <span className="mb-4 inline-block rounded-full bg-primary px-3 py-1 text-xs font-semibold text-primary-foreground">
                Featured
              </span>
              <h2 className="mb-3 text-2xl font-bold text-foreground group-hover:text-primary sm:text-3xl">
                {featured.title}
              </h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post, i) => (
            ...
            >
              <Link
                href={`/blog/${post.slug}`}
                className="group flex h-full flex-col rounded-xl border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
