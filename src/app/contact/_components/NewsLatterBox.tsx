...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div data-oid=".e-ybux">
        <span className="absolute left-2 top-7" data-oid="l.b4lnf">
          <svg
            width="57"
            height="65"
            viewBox="0 0 57 65"
        ...
        <span className="absolute bottom-24 left-1.5" data-oid="0:wk:s3">
          <svg
            width="39"
            height="32"
            viewBox="0 0 39 32"
        ...
        <span className="absolute right-2 top-[140px]" data-oid="t:u5sfz">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
        ...
        <span className="absolute right-0 top-0" data-oid="6i:swj4">
          <svg
            width="162"
            height="91"
            viewBox="0 0 162 91"
            ...
            data-oid="j5:e2c:"
          >
            <g opacity="0.3" data-oid="mg6toyp">
              <path
                opacity="0.45"
