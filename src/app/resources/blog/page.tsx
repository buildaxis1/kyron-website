...
const Blog = () => {
  ...
  return (
    <>
      ...
      <section className="pb-[120px] pt-[120px]" data-oid="eh88hh1">
        <div className="container" data-oid="hbo2h32">
          {/* <div
            ...
            {blogData.map((blog) => (
              ...
              >
                ...
                <div
                  ...
                  data-oid="fc:g25."
                >
                  <TbLogs data-oid="j.3guix" />
                </div>
                <div className="p-6" data-oid="mntkcll">
                  <h3
                    className="mb-4 line-clamp-1 text-xl font-bold text-foreground"
                    data-oid="a3cj:j:"
                  >
                    {blog.title}
                  </h3>
                  <p
                    className="line-clamp-1 text-lg text-muted-foreground"
                    data-oid="hwa24jw"
                  >
                    {blog.description}
                  </p>
                  ...
                  {/* Footer */}
                  <div className="mt-4" data-oid="j3-b-62">
                    <hr className="mb-4 border-border" data-oid="vw:t5m_" />
                    <button
                      onClick={() => {
                        setCurrentResource({
                          url: blog.link,
