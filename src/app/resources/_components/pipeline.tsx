...
const Pipeline = () => {
  ...
  const handleSubmit = async () => {
    window.location.href = `https://kyronmedical.com/contact`;
  ...
  return (
    <section id="prototype" className="my-8 text-center" data-oid="l9m8z6p">
      <div
      ...
      >
        ...
        >
          ...
          <div className="mt-8" data-oid="l9km8o:">
            <GetStarted data-oid="-pjq8i0" />
          </div>
        </div>
      </div>
    </section>
